...
//
//       // driver.findElement(By.className("DateOfBirthDay")).sendKeys("12");
//       // driver.findElement(By.className("DateOfBirthMonth")).sendKeys("12");
//      //  driver.findElement(By.className("DateOfBirthYear")).sendKeys("1990");
